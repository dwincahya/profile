...
const Projects = () => {
    ...
    return (
        <section className="bg-gray-900 py-16 px-8 md:py-24 md:px-16">
            ...
            <div className="text-white grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 px-0 md:px-48">
                {projects.map((project) => (
                    <a 
                        ...
                        className="border-white p-4 rounded-lg border-[3px] border-slate-800 text-center hover:scale-105 transition-all"
                    >
                        <img 
                            src={project.image} 
                            alt={project.title} 
